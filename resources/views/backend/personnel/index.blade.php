...
@section('content')
    ...
    <link href="{{ asset('backend/src/assets/css/light/apps/contacts.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('backend/src/assets/css/dark/components/modal.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('backend/src/assets/css/dark/apps/contacts.css') }}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="items items-header-section">
                                <div class="item-content">
                                    ...
                                    <div class="user-location">
                                        <h4 style="margin-left: 0;">Adresse</h4>
                                    </div>
                                    <div class="user-phone">
                                        <h4 style="margin-left: 3px;">Téléphone</h4>
                                    </div>
                                ...
                                <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            ...
                                            <img src="{{ $personnel->profile_image ?? asset('default_user.png') }}" alt="{{$personnel->name}}">
                                            <div class="user-meta-info">
                                                <p class="user-name" data-name="{{$personnel->name}}">{{$personnel->name}}</p>
                                                <p class="user-work" data-occupation="{{$personnel->role_as}}">{{$personnel->role_as}}</p>
                                            </div>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">Email: </p>
                                            <p class="usr-email-addr" data-email="{{$personnel->email}}">{{$personnel->email}}</p>
                                        </div>
                                        <div class="user-location">
                                            <p class="info-title">Location: </p>
                                            <p class="usr-location" data-location="{{$personnel->address}}">{{$personnel->address}}</p>
                                        </div>
                                        <div class="user-phone">
                                            <p class="info-title">Téléphone: </p>
                                            <p class="usr-ph-no" data-phone="{{$personnel->telephone}}">{{$personnel->telephone}}</p>
                                        </div>
                                        <div class="action-btn">
    ...
    <script src="{{ asset('backend/src/assets/js/apps/contact.js') }}"></script>
    @endpush
@endsection